...
router.put("/edit/:id", CarritoController.editarCarrito); //Editar un carrito

router.delete("/delete/:id", CarritoController.eliminarCarrito); //Eliminar un carrito de la lista
